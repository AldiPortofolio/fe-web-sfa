...
import { NEWAPI, NEWAPI_V2_2 } from "../actions/constants";

var dateNow = new Date();
var dateNow2 = moment(dateNow, "DDMMYYYY");
dateNow2 = dateNow2.format("DDMMYYYY");

class MerchantBulk extends React.Component {
  state = {
    confirmIsOpen: false,
    TemplateBulk: "load",
    type: "",
  ...
  uploadBulk = () => {
    if (this.refs.file.files) {
      ...
      axios
        .post(NEWAPI + `/merchants/bulk_status`, data)
        .then((data) => {
          let result = data.data;
          if (result.meta.status === false) {
            this.setState({
            ...
            this.setState({
              confirmIsOpen: true,
              type: "success",
              textSuccess: `Bulk upload set status merchant sukses`,
              uploadStatus: "Upload",
              confirmSuccess: true,
            });
          }
        ...
        .catch((e) => {
          this.setState({
            confirmIsOpen: true,
            type: "error",
            textSuccess: `Bulk upload set status merchant gagal`,
            uploadStatus: "Upload",
          ...
          <div className="card-body">
            <div className="row mb-4">
              <div className="col-12">
                <h6>Set Status Merchant Bulk</h6>
