...
import { createTaskCategory } from "../../actions/task_category";
...
class Add extends Component {
  ...
  componentWillMount() {
    document.title = "SFA OTTO - Add Task Kategory";
  }
  ...
  handleSubmit = (e) => {
    ...
    const { createTaskCategory } = this.props;
      ...
      .then((data) => {
        if (data.meta.status === false) {
          ...
          this.setState({
            ...
            confirmIsOpen: true,
            type: "success",
            textSuccess: "Tambah data task kategori sukses",
          });
        }
      })
      .catch((e) =>
        this.setState({
          ...
          confirmIsOpen: true,
          type: "error",
          textSuccess: "Tambah data task kategori gagal",
        })
      );
  };
